...
public class RedHot() : SpireEnigmasCard.SacrificeCard(2, CardType.Skill, CardRarity.Rare, TargetType.AnyEnemy)
{
    protected override IEnumerable<DynamicVar> CanonicalVars =>
    [
        new PowerVar<CharredPower>(10)
    ];
    ...
    protected override void OnUpgrade() => DynamicVars["CharredPower"].UpgradeValueBy(5);
}