...
using SpireEnigmas.SpireEnigmasCode.Cards.chronicle.basic;
...
using SpireEnigmas.SpireEnigmasCode.Relics.chronicle;
...
public class TheChronicle : PlaceholderCharacterModel
{
    public override string PlaceholderID => "necrobinder";
    
    public const string CharacterId = "TheChronicle";
    ...
    public override IEnumerable<CardModel> StartingDeck => [
        ModelDb.Card<StrikeChronicle>(),
        ModelDb.Card<StrikeChronicle>(),
        ModelDb.Card<StrikeChronicle>(),
        ModelDb.Card<StrikeChronicle>(),
        ModelDb.Card<DefendChronicle>(),
        ModelDb.Card<DefendChronicle>(),
        ModelDb.Card<DefendChronicle>(),
        ModelDb.Card<DefendChronicle>(),
        ModelDb.Card<Despair>(),
        ModelDb.Card<Talisman>()
    ];

    
    public override IReadOnlyList<RelicModel> StartingRelics =>
    [
        ModelDb.Relic<YearningEnchiridion>()
    ];
    
    
    public override CardPoolModel CardPool => ModelDb.CardPool<TheChronicleCardPool>();
    public override RelicPoolModel RelicPool => ModelDb.RelicPool<TheChronicleRelicPool>();
    public override PotionPoolModel PotionPool => ModelDb.PotionPool<TheChroniclePotionPool>();
